...
//删除好友
#define MESSAGE_Delete_Friend 95
...
#define GROUP_ANNOUNCEMENT_MESSAGE 2000  // 群公告消息
#define GROUP_ANNOUNCEMENT_DELETE_MESSAGE 2001  // 删除群公告消息


#define MESSAGE_CONTENT_TYPE_GROUP_MESSAGE_TOP 2002  // 群消息置顶的通知消息

#define MESSAGE_CONTENT_TYPE_GROUP_MESSAGE_DELETE_TOP 2003  // 群消息取消置顶的通知消息


#define MESSAGE_LOAD_TIP 888888  //这条消息告诉app load后ws推的消息开始和结束

#define MESSAGE_LOAD_END_TIP 888889  //这条消息告诉app load后ws推的消息结束

#define MESSAGE_FRIENDINFO_CHANGE 110000  //好友备注发生改变

#define MESSAGE_READED 110001  //消息已读通知

#define MESSAGE_FRIEND_TAG_CHANGE 110002  //更新标签

#define MESSAGE_Unkwon 10001
#endif /* Common_h */
