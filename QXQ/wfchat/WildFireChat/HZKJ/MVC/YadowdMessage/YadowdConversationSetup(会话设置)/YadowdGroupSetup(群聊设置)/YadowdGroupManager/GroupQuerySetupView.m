...
@implementation GroupQuerySetupView
...
- (void)showUI {
    ...
    titleLabel.text = LLLLLL(@"GroupCanbeSearchTitle");
    ...
    _s1Button = [self createOptionButtonWithTitle:LLLLLL(@"GroupCanbeSearch") yPosition:50 tag:0];
    ...
    // 创建 30 天按钮
    _s2Button = [self createOptionButtonWithTitle:LLLLLL(@"GroupCannotSearch") yPosition:100 tag:1];
