//
//  HESIXCGATGroupNotificationVC.m
//  WildFireChat
//
...
#import "HESIXCGATGroupNotificationVC.h"
#import "CHGSTIAEXCallosTVCell.h"

#import "GroupNotificationAcceptVC.h"
#import "GroupNotificationAcceptBBVC.h"

@interface HESIXCGATGroupNotificationVC ()<UITableViewDelegate, UITableViewDataSource>
{
    BOOL _isChinese;
}
...
@implementation HESIXCGATGroupNotificationVC
...
- (void)setAcceptList:(WaitAcceptList *)acceptList {
    ...
    if (acceptList.type == 0) { // 申请(icon/name 个人用户的信息)
        ...
        [self.iconView sd_setImageWithURL:URL(groupInfo.portrait) placeholderImage:[QWERImage imageNamed:@"groupIcon"]];
