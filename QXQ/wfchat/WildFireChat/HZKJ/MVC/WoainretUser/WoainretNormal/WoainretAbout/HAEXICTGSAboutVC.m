...
#import "HAEXICTGSAboutVC.h"

#import "WOPMKDIOFZTWebviewVC.h"
#import "HAEXICTGSFeedbackVC.h"
#import "QZBGNRJYDIOZProtocolVC.h"

@interface HAEXICTGSAboutVC ()
...
@implementation HAEXICTGSAboutVC
...
- (IBAction)waxiouvGWUserFeedbackClears:(UIButton *)sender {
    if (sender.tag <= 1) {
        ...
        HAEXICTGSFeedbackVC *vc = HAEXICTGSFeedbackVC.new;
        [self.navigationController pushViewController:vc animated:YES];
