...
- (void)onFileBtn:(id)sender {
    if ([AIOIUEHConfigManager globalManager].fileTransferId) {
        AIOIUEHMessageListVC *mvc = [[AIOIUEHMessageListVC alloc] init];
        mvc.conversation = [WFCCConversation conversationWithType:Single_Type target:[AIOIUEHConfigManager globalManager].fileTransferId line:0];
