...
@interface JUAHODJNKAddFriendVC () <UITableViewDataSource, UISearchControllerDelegate, UISearchResultsUpdating, UITableViewDelegate, UISearchBarDelegate>
...
@implementation JUAHODJNKAddFriendVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.searchController.active) {
        ...
        JUAHODJNKProfileTableVC *pvc = [[JUAHODJNKProfileTableVC alloc] init];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AIOIUEHGeneralImageTextTVCell *cell = [tableView dequeueReusableCellWithIdentifier:flag];
    if (cell == nil) {
        cell = [[AIOIUEHGeneralImageTextTVCell alloc] initWithReuseIdentifier:flag cellHeight:CELL_HEIGHT];
    }
    if(self.texting) {
        ...
        cell.portraitIV.image = [AIOIUEHImage imageNamed:@"search_icon"];
    } else {
        WFCCUserInfo *userInfo = self.searchList[indexPath.row];
        [cell.titleLable setText:userInfo.displayName];
        [cell.portraitIV sd_setImageWithURL:[NSURL URLWithString:[userInfo.portrait stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[AIOIUEHImage imageNamed:@"PersonalChat"] options:SDWebImageScaleDownLargeImages
