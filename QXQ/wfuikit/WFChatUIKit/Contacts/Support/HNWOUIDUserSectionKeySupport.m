//
//  HNWOUIDUserSectionKeySupport.m
//  WFChatUIKit
//
...
@implementation HNWOUIDUserSectionKeySupport
+ (NSMutableDictionary *)userSectionKeys:(NSArray *)userList {
    ...
    for (NSString *favUser in favUsers) {
        for (HNWOUIDSelectModel *userInfo in userList) {
    ...
    for (NSString *key in _keys) {
        ...
        for (id user in userList) {
            ...
            HNWOUIDSelectModel *model = (HNWOUIDSelectModel *)user;
            NSString *userName = model.userInfo.displayName;
            if (model.userInfo.alias.length) {
                userName = model.userInfo.alias;
            }
    ...
    [infoDic enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
        ...
        [_tempOtherArr sortUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
            HNWOUIDSelectModel *user1 = (HNWOUIDSelectModel *)obj1;
            HNWOUIDSelectModel *user2 = (HNWOUIDSelectModel *)obj2;
