...
@interface AIOIUEHUserMessageListVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation AIOIUEHUserMessageListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    WFCCUserInfo *userInfo = [[WFCCUserDB sharedManager] getUserInfo:self.userId];
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [AIOIUEHUtilities formatTimeDetailLabel:msg.serverTime];
    return cell;
}
