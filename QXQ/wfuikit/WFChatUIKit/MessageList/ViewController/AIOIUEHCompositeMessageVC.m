...
@interface AIOIUEHCompositeMessageVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation AIOIUEHCompositeMessageVC
...
#define HEADER_LINE_PADDING 16
    ...
    CGSize size = [AIOIUEHUtilities getTextDrawingSize:timeString font:[UIFont systemFontOfSize:HEADER_FONT_SIZE] constrainedSize:CGSizeMake(width, HEADER_HEIGHT)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SMIOUEJCompositeBaseCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([msg.content class])];
    if (!cell) {
        cell = [SMIOUEJCompositeBaseCell cellOfMessage:msg];
    }
