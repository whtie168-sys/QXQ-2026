//
//  SMIOUEJCompositeUnknownCell.h.m
//  WFChatUIKit
//
...
@implementation SMIOUEJCompositeUnknownCell
...
+ (CGFloat)heightForMessageContent:(WFCCMessage *)message {
    ...
    CGSize size = [AIOIUEHUtilities getTextDrawingSize:[message.content digest:message] font:[UIFont systemFontOfSize:18] constrainedSize:CGSizeMake(frame.size.width, 8000)];
    return size.height;
}
