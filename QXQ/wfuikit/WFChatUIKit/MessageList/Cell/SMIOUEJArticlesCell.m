...
@implementation SMIOUEJArticlesCell
+ (CGSize)sizeForCell:(AIOIUEHMessageModel *)msgModel withViewWidth:(CGFloat)width {
    ...
    if(content.subArticles.count) {
        ...
        CGSize titleSize = [AIOIUEHUtilities getTextDrawingSize:content.topArticle.title font:[UIFont systemFontOfSize:TOP_TITLE_FONT_SIZE] constrainedSize:CGSizeMake(containerWidth-CELL_PADDING-CELL_PADDING, 50)];
