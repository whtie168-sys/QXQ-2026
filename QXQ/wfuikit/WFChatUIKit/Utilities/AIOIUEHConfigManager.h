...
#import "AIOIUEHAppServiceProvider.h"
#import "LUDHIOWIVOrgServiceProvider.h"
...
@interface AIOIUEHConfigManager : NSObject
...
@property(nonatomic, weak)id<AIOIUEHAppServiceProvider> appServiceProvider;

@property(nonatomic, weak)id<LUDHIOWIVOrgServiceProvider> orgServiceProvider;
