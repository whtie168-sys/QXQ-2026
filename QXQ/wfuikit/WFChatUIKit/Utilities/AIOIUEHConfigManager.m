...
static AIOIUEHConfigManager *sharedSingleton = nil;
@implementation AIOIUEHConfigManager

+ (AIOIUEHConfigManager *)globalManager {
    if (sharedSingleton == nil) {
        @synchronized (self) {
            if (sharedSingleton == nil) {
                sharedSingleton = [[AIOIUEHConfigManager alloc] init];
...
//    bar.barTintColor = [AIOIUEHConfigManager globalManager].naviBackgroudColor;
//    bar.tintColor = [AIOIUEHConfigManager globalManager].naviTextColor;
//    bar.titleTextAttributes = @{NSForegroundColorAttributeName : [AIOIUEHConfigManager globalManager].naviTextColor};
...
//        navBarAppearance.backgroundColor = [AIOIUEHConfigManager globalManager].naviBackgroudColor;
//        navBarAppearance.titleTextAttributes = @{NSForegroundColorAttributeName:[AIOIUEHConfigManager globalManager].naviTextColor};
//    }
//    
//    [[UITabBar appearance] setBarTintColor:[AIOIUEHConfigManager globalManager].frameBackgroudColor];
