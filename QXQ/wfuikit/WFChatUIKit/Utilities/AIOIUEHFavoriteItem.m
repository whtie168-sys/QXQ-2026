...
@implementation AIOIUEHFavoriteItem
+ (AIOIUEHFavoriteItem *)itemFromMessage:(WFCCMessage *)message {
    ...
    if(message.conversation.type == Single_Type) {
        WFCCUserInfo *userInfo = [[WFCCUserDB sharedManager] getUserInfo:message.conversation.target];
