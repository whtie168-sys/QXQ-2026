...
@property (strong, nonatomic, nonnull) UIImage *logoImage UI_APPEARANCE_SELECTOR;        // default is the bundled success image provided by Freepik
...
+ (void)showLogoWithStatus:(nullable NSString*)status;
