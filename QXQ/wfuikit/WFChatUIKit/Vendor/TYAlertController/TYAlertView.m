...
#define kyzdoajTextLabelSpace  6
...
- (void)configureProperty
{
    ...
    _yzdoajTextLabelSpace = kyzdoajTextLabelSpace;
    _yzdoajTextLabelContentViewEdge = kContentViewEdge;
...
- (void)layoutContentViews
{
    ...
    [self addConstraintWithView:_textContentView topView:self leftView:self bottomView:nil rightView:self edgeInset:UIEdgeInsetsMake(_contentViewSpace, _yzdoajTextLabelContentViewEdge, 0, -_yzdoajTextLabelContentViewEdge)];
...
- (void)layoutyzdoajTextLabels
{
    ...
    [_textContentView addConstraintWithTopView:_titleLable toBottomView:_messageLabel constant:_yzdoajTextLabelSpace];
