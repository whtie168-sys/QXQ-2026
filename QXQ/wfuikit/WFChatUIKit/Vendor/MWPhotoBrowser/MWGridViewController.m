...
//    self.collectionView.contentInset = UIEdgeInsetsMake(10.0, 0, 0, 0);
    NSIndexPath *finalIndexPath = [NSIndexPath indexPathForItem:[_browser numberOfPhotos] - 1 inSection:0];
...
- (UIEdgeInsets)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout insetForSectionAtIndex:(NSInteger)section {
    CGFloat margin = [self getMargin];
    return UIEdgeInsetsMake(2.0, margin, margin, margin);
}
