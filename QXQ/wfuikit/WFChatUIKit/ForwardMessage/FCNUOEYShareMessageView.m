...
@interface FCNUOEYShareMessageView ()
...
@implementation FCNUOEYShareMessageView
- (void)updateUI {
...
- (void)setConversation:(WFCCConversation *)conversation {
    ...
    if (conversation.type == Single_Type) {
        ...
        [self.portraitImageView sd_setImageWithURL:[NSURL URLWithString:[portrait stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[AIOIUEHImage imageNamed:@"PersonalChat"] options:SDWebImageScaleDownLargeImages
...
//            if (groupInfo.portrait.length) {
                [self.portraitImageView sd_setImageWithURL:[NSURL URLWithString:[groupInfo.portrait stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[AIOIUEHImage imageNamed:@"groupIcon"] options:SDWebImageScaleDownLargeImages
                                                   context:@{SDWebImageContextImageForceDecodePolicy : @(SDImageForceDecodePolicyNever), SDWebImageContextStoreCacheType : @(SDImageCacheTypeDisk)}];
//            } else {
...
//                
//                if (path) {
//                    [self.portraitImageView sd_setImageWithURL:[NSURL fileURLWithPath:path] placeholderImage:[AIOIUEHImage imageNamed:@"groupIcon"]];
//                }
//            }
        } else {
            name = @"群聊";
            [self.portraitImageView setImage:[AIOIUEHImage imageNamed:@"groupIcon"]];
        }
        ...
        [self.portraitImageView sd_setImageWithURL:[NSURL URLWithString:[portrait stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[AIOIUEHImage imageNamed:@"channel_default_portrait"] options:SDWebImageScaleDownLargeImages
                                           context:@{SDWebImageContextImageForceDecodePolicy : @(SDImageForceDecodePolicyNever), SDWebImageContextStoreCacheType : @(SDImageCacheTypeDisk)}];
